...
<body>
    ...
    <div class="banner_bg_main">
        ...
        <div class="logo_section">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="logo"><a href="index.html"><img src="{{ asset('web/images//logo.png') }}"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="containt_main">
                    ...
                    <span class="toggle_icon" onclick="openNav()"><img
                            src="{{ asset('web/images//toggle-icon.png') }}"></span>
                    ...
                    <div class="header_box">
                        <div class="lang_box ">
                            <a href="#" title="Language" class="nav-link" data-toggle="dropdown"
                                aria-expanded="true">
                                <img src="{{ asset('web/images//flag-uk.png') }}" alt="flag" class="mr-2 "
                                    title="United Kingdom"> English <i class="fa fa-angle-down ml-2"
                                    aria-hidden="true"></i>
                            </a>
                            <div class="dropdown-menu ">
                                <a href="#" class="dropdown-item">
                                    <img src="{{ asset('web/images//flag-france.png') }}" class="mr-2"
                                        alt="flag">
                                    French
                                </a>
                            </div>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="buynow_bt"><a href="{{ url('/cart') }}">Buy Now</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h1 class="banner_taital">Get start<br>dashboard admin</h1>
                                        <div class="buynow_bt"><a href="{{ url('/dash') }}">go Now</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-lg-4 col-sm-4">
                                        <div class="box_main">
                                            ...
                                            <p class="price_text"> Price : <span
                                                    style="color: #262626;">{{ $product->salary }} $</span></p>
                                            <div class="electronic_img"><img
                                                    src="{{ asset('web/images/' . $product->image) }}"></div>
    ...
    <div class="footer_section layout_padding">
        <div class="container">
            <div class="footer_logo"><a href="index.html"><img src="{{ asset('web/images//footer-logo.png') }}"></a>
            </div>
            <div class="input_bt">
            ...
            <script type="text/javascript" src="{{ asset('web/js/masonry.min.js') }}"></script>
